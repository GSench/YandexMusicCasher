...
public abstract class IntentService extends Service {
    ...
    private final class UIServiceHandler extends Handler {
    ...
    public void onCreate() {
        ...
        mUIServiceHandler = new UIServiceHandler();
    }
    ...
    public void postOnUIThread(Runnable runnable){
        Message msg = mUIServiceHandler.obtainMessage();
        msg.what = what;
        msg.obj = runnable;
        mUIServiceHandler.sendMessage(msg);
    }
